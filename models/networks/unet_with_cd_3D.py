...
class unet_with_cd_3D(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=2, is_deconv=True, in_channels=4,
        ...
        super(unet_with_cd_3D, self).__init__()
    ...
    def forward(self, inputs, clinical_data):
        ...
        cd_fc2 = self.fc2(cd_fc1)
        cd_fc2 = self.relu(cd_fc2)
        
        decoded_clinical_data = cd_fc2.view((-1,256,1,1,1))*center
