...
class unet_pCT_cd_multi_down_3D(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=2, is_deconv=True, in_channels=4,
        ...
        # add clinical data
        self.fc1 = nn.Linear(21,filters[0])
        self.attentionblockmed1 = MultiAttentionBlock(in_size=filters[4], gate_size=filters[4], inter_size=filters[1],
                                                     nonlocal_mode=nonlocal_mode, sub_sample_factor=attention_dsample)
        self.fc2 = nn.Linear(21,filters[1])
        self.attentionblockmed2 = MultiAttentionBlock(in_size=filters[4], gate_size=filters[4], inter_size=filters[1],
                                                     nonlocal_mode=nonlocal_mode, sub_sample_factor=attention_dsample)
        self.fc3 = nn.Linear(21,filters[2])
        self.attentionblockmed3 = MultiAttentionBlock(in_size=filters[4], gate_size=filters[4], inter_size=filters[1],
                                                     nonlocal_mode=nonlocal_mode, sub_sample_factor=attention_dsample)
        self.fc4 = nn.Linear(21,filters[3])
        self.attentionblockmed4 = MultiAttentionBlock(in_size=filters[4], gate_size=filters[4], inter_size=filters[1],
                                                     nonlocal_mode=nonlocal_mode, sub_sample_factor=attention_dsample)

        self.fc5a = nn.Linear(21, 64)
        self.fc5b = nn.Linear(64,filters[4]) #256*1*1*1
        self.relu = nn.ReLU()
        self.attentionblockmed5 = MultiAttentionBlock(in_size=filters[4], gate_size=filters[4], inter_size=filters[1],
                                                   nonlocal_mode=nonlocal_mode, sub_sample_factor= attention_dsample)
    ...
    def forward(self, inputs, clinical_data):
        ...
        cd_fc1 = cd_fc1.view((-1, filters[1], 1, 1, 1)) * conv1
        ...
        cd_fc2 = cd_fc2.view((-1, filters[2], 1, 1, 1)) * conv2
        ...
        cd_fc3 = cd_fc3.view((-1, filters[3], 1, 1, 1)) * conv3
        ...
        cd_fc4 = cd_fc4.view((-1, filters[4], 1, 1, 1)) * conv4
        ...
        decoded_clinical_data = cd_fc5b.view((-1, filters[4], 1, 1, 1)) * center
